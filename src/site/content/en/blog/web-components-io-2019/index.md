...
src="https://www.youtube.com/embed/HAJfuTvxqkk" frameborder="0"
...
<figure class="w-figure w-figure--fullbleed">
  <img src="./usage-graoh.png" alt="Graph showing usage of custom elements v0 and v1 specifications.">
</figure>

You can find web components on sites you probably use every day, like YouTube and GitHub. They're also used on many news and publishing sites built with AMP—AMP components are also web components. And many enterprises are also adopting web components.
...
To get started building your own components, you can check out LitElement, a web component base class developed here at Google that has a great functional rendering experience similar to React.
